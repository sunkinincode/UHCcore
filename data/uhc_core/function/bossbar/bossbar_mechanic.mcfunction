...
# actionbar suggest
execute if score Allow UHCcore.Allowtrigger matches 1 run title @a[team=!players,team=!observer] actionbar [{"text":"▶ You can join the UHC by ","color":"green"},{"text":"/trigger UHCcore.join","color":"gold"},{"text":" or observe by ","color":"green"},{"text":"/trigger UHCcore.observe","color":"red"},{"text":" ◀","color":"green"}]

# if not playing UHC always show player amount bossbar
execute if score playing Start.UHC matches 0 run bossbar set minecraft:amount.player.joined players @a
execute if score playing Start.UHC matches 0 run bossbar set minecraft:amount.player.joined visible true
...
# player trigger toggle bossbar
execute as @a[scores={toggle.bossbar=1}] run function uhc_core:bossbar/trigger_toggle_bossbar

# show  and switch bossbar
execute if score StartCount UHCcore.Timer matches 1 if score playing Start.UHC matches 1 if score bossbar.switch UHCcore.Timer matches 1 run bossbar set minecraft:worldborder.coordinate visible true
execute if score StartCount UHCcore.Timer matches 1 if score playing Start.UHC matches 1 if score bossbar.switch UHCcore.Timer matches 1 run bossbar set minecraft:uhc.timer visible false
execute if score StartCount UHCcore.Timer matches 1 if score playing Start.UHC matches 1 if score bossbar.switch UHCcore.Timer matches 1 run bossbar set minecraft:worldborder.coordinate players @a[tag=!dontShowBossbar4Me]

execute if score StartCount UHCcore.Timer matches 1 if score playing Start.UHC matches 1 if score bossbar.switch UHCcore.Timer matches 2 run bossbar set minecraft:uhc.timer visible true
execute if score StartCount UHCcore.Timer matches 1 if score playing Start.UHC matches 1 if score bossbar.switch UHCcore.Timer matches 2 run bossbar set minecraft:worldborder.coordinate visible false
execute if score StartCount UHCcore.Timer matches 1 if score playing Start.UHC matches 1 if score bossbar.switch UHCcore.Timer matches 2 run bossbar set minecraft:uhc.timer players @a[tag=!dontShowBossbar4Me]
