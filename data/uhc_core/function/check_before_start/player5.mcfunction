...
execute unless score Players UHCcore.PlayerAmount matches 5.. run tellraw @s [{"text":"[UHCcore] ","bold":true,"color":"gold"},{"text":"Amount of players who want to play has not enough","color":"gold"}]
